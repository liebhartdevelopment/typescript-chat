namespace Chat {
  export class DocumentHelper {
    public static initialize(): void {
      DocumentHelper.getInputElement("username").addEventListener(
        "keyup",
        DocumentHelper.userKeyUp
      );
      DocumentHelper.getInputElement("entry").addEventListener(
        "keyup",
        DocumentHelper.entryKeyUp
      );
    }
